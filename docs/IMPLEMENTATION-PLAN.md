...
- **Panel-Cockpit-Redesign (F):**
  ...
  - **R1.4 — restliche Tools** *(offen)*: **Wolken** (Zickzack 10–16 Uhr, Tiefe/Dichte), **Ränder** (Sonnenauf/-untergang weichzeichnen, Smoothstep), **Zeit** (Kurve ±verschieben). Logik liegt im App-Mockup vor.
